...
# Copyright (C) 2018  mungi <will2you@gmail.com>
#
...
class ListSoftlayer(object):
    ...
    def parse_options(self):
        ...
        parser.add_argument('-r', '--reversesort', action='store_true', default=False,
                            help='Sorting in Descending Order (default: False)')
        ...
        for srv in servers:
            if self.args.detail:
                ...
                self.listSL.add_row([
                    ...
                    srv['domain'],
                    srv[type_col[0]],
                    srv[type_col[1]] if type == self.BMS else int(int(srv[type_col[1]])/1024),
    ...
    def list_servers(self):
        ...
        print(self.listSL.get_string(sortby=self.args.sort, reversesort=self.args.reversesort))
